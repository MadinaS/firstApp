    ...
    this.platform.ready().then(() => {
      ...
      db.openDatabase({
        ...
        db.executeSql("DROP TABLE IF EXISTS nachrichten", {});
          ...
          db.executeSql("CREATE TABLE IF NOT EXISTS nachrichten (id INTEGER PRIMARY KEY AUTOINCREMENT, userID INTEGER, sender TEXT, mTime INTEGER, titel TEXT, message TEXT, foto TEXT)", {}).then((data) => {
            ...
            console.log("Unable to execute sql");
          });
